...
//
//
//app.directive('chartfour', function() {
//    return {
//        restrict: 'E',
//        template: "<div style='float:left; margin-top:20px;margin-left:20px;'>hello</div>",
//        scope: {
//            chartValue: "=value",
//            chartObjfour: "=?"
//        },
...
//                if($scope.chartData.series.length!=0)
//                	{
//                $scope.chartObjfour = new Highcharts.Chart($scope.chartData);
//                 console.log( $scope.chartObjfour);
//                 activate=1;
//                	 }
////                }
//            	
...
//                  	//                 		 var xseries=$scope.chartObj.xAxis.categories;
//                 	//	console.log(xseries);
//                 		 	                      var yseries =$scope.chartObjfour.series;
////	                      console.log($scope.chartData.series);
//						  
//                         timeSeries=parseEpochTime(s[2].data);
//   				         console.log($scope.chartData.series);
